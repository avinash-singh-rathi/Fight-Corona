...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Create Precaution <span class="float-right"><a href="{{route('precautions.index')}}">Back</a></span></div>

                <div class="card-body">
                    <form method="POST" action="{{ route('precautions.store') }}" enctype="multipart/form-data">
                        @csrf
