...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Create Lost Patient <span class="float-right"><a href="{{route('lostpatients.index')}}">Back</a></span></div>

                <div class="card-body">
                    <form method="POST" action="{{ route('lostpatients.store') }}" enctype="multipart/form-data">
                        @csrf
