                    ...
                    <form method="POST" action="{{ route('suppliers.update',$supplier->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="country_id">{{ __('Country') }}</label>
                                <select id="country_id" class="form-control @error('country_id') is-invalid @enderror" required name="country_id">
                                  ...
                                  <option value="{{$country->id}}" @if(old('country_id') == $country->id || $supplier->city->district->state->country_id == $country->id) selected @endif>{{$country->name}}</option>
                                  @endforeach
                                </select>
                                @error('country_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            <label for="state_id">{{ __('State') }}</label>
                                ...
                                <input type="hidden" value="{{ old('state_id',$supplier->city->district->state_id) }}" name="stateme" id="stateme">
                                @error('state_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            <label for="district_id">{{ __('District') }}</label>
                                ...
                                <input type="hidden" value="{{ old('district_id',$supplier->city->district_id) }}" name="districtme" id="districtme">
                                @error('district_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
